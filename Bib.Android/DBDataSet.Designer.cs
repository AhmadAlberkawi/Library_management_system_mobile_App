...
namespace Bib.Droid {
    ...
    public partial class DBDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PersonRow AddPersonRow(string Name, string Vorname, string Email, string Foto) {
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public string Foto {
                get {
                    return ((string)(this[this.tablePerson.FotoColumn]));
                }
                set {
                    this[this.tablePerson.FotoColumn] = value;
                }
            }
        }
...
namespace Bib.Droid.DBDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_N" +
                "ame) AND ([Vorname] = @Original_Vorname) AND ([Email] = @Original_Email) AND ([F" +
                "oto] = @Original_Foto))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([Name], [Vorname], [Email], [Foto]) VALUES (@Name, @V" +
                "orname, @Email, @Foto);\r\nSELECT Id, Name, Vorname, Email, Foto FROM Person WHERE" +
                " (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [Name] = @Name, [Vorname] = @Vorname, [Email] = @Email, [Foto] = @Foto WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Vorname] = @Original_Vorname) AND ([Email] = @Original_Email) AND ([Foto] = @Original_Foto));
SELECT Id, Name, Vorname, Email, Foto FROM Person WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Vorname, Email, Foto FROM dbo.Person";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Vorname, string Original_Email, string Original_Foto) {
        ...
        public virtual int Insert(string Name, string Vorname, string Email, string Foto) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Vorname, string Email, string Foto, int Original_Id, string Original_Name, string Original_Vorname, string Original_Email, string Original_Foto, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Vorname, string Email, string Foto, int Original_Id, string Original_Name, string Original_Vorname, string Original_Email, string Original_Foto) {
            return this.Update(Name, Vorname, Email, Foto, Original_Id, Original_Name, Original_Vorname, Original_Email, Original_Foto, Original_Id);
        }
    }
